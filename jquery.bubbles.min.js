...
*/
(function(g){var p=function(){return new o.init(arguments)},o=p.prototype={opts:{center:{lat:36.915,lng:-95.225},markers:[{lat:35.289,lng:-94.756,title:"woot",content:'<div class="iw-content"><p>Hello World!!</p></div>'}],markerIcon:"images/google-maps-icon.png",markerShadow:"images/google-maps-shadow.png",windowImage:"images/google-maps-infobox.png",closeImage:"images/google-maps-close.png",offsetVertical:-226,offsetHorizontal:-20,iwWidth:208,iwHeight:165},init:function(b){b=Array.prototype.slice.call(b);
...
var c=a.title,h=this.opts.markerIcon,f=this.opts.markerShadow,i=a.content,j=new google.maps.LatLng(a.lat,a.lng),e=new google.maps.Marker({position:j,map:b,title:c,icon:h,shadow:f}),d=this.opts;google.maps.event.addListener(e,"click",function(){new k({latlng:e.getPosition(),map:b,content:i,offsetVertical:d.offsetVertical,offsetHorizontal:d.offsetHorizontal,height:d.iwHeight,width:d.iwWidth,windowImage:d.windowImage,closeImage:d.closeImage})})}};o.init.prototype=o;var k=function(b){var a=this;google.maps.OverlayView.call(a);
...
this.panMap()}};k.prototype.panMap=function(){var b=this.map,a=b.getBounds();if(a){var c=this.latlng,h=this.width,f=this.height,i=this.offsetHorizontal,j=this.offsetVertical,e=b.getDiv(),d=e.offsetWidth;e=e.offsetHeight;var l=a.toSpan(),m=l.lng(),n=l.lat();l=m/d;n=n/e;e=a.getSouthWest().lng();m=a.getNorthEast().lng();d=a.getNorthEast().lat();a=a.getSouthWest().lat();var q=c.lng()+(i-40)*l;i=c.lng()+(i+h+40)*l;h=c.lat()-(j-40)*n;c=c.lat()-(j+f+40)*n;f=(q<e?e-q:0)+(i>m?m-i:0);c=(h>d?d-h:0)+(c<a?a-c:
...
function(){var b=Array.prototype.slice.call(arguments);return this.each(function(){b.unshift(this);p.apply(null,b)})}})(jQuery);
